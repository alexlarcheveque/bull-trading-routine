# portfolio.md
# Updated 2026-06-05 15:55 by eod routine.

## Account
- equity: 99489.92
- cash: 90085.46
- buying_power: 379150.76
- day_pnl_pct: -0.64

## Open positions
| ticker | instrument | qty | entry_price | entry_date | target_exit | unrealized_pnl_pct |
|--------|------------|-----|-------------|------------|-------------|--------------------|
| A      | equity     | 36  | 133.745278  | 2026-05-28 | 2026-06-11  | +1.20              |
| SMTC   | equity     | 30  | 165.00      | 2026-05-27 | 2026-06-10  | -8.23              |
...
Risk flags as of EOD 2026-06-05:
- Thesis check UNAVAILABLE: Grok API credits exhausted since 2026-06-02 pre-market (day 4); no thesis-broken sells possible
- A: +1.20% (stop at -12%=$117.70, target at +25%=$167.18 — within range, hold)
- SMTC: -8.23% (stop at -12%=$145.20 — not near stop; -10.56% intraday drop today but return vs entry still -8.23%)
- Open positions: 2/5 (3 slots available)
- WTD P&L: -0.60% (cap -30%) — clear
