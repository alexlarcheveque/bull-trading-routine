...
2026-06-16 EOD: 0 time-stops, 0 expiry-guard exits. TSEM live bid=$11.42 (ret=-52.02%) — stop at $9.52 not triggered; expiry 2026-06-26 (8 trading days, guard clear); time stop 2026-06-22 not yet reached. Weekly cap CLEAR (-11.80% WTD vs -80%). EOD email sent (id: 75d3c457).
2026-06-17 market-open: 0 buys, 0 exits. TSEM bid=$10.10 (ret=-57.56%). Stop not triggered ($9.52 threshold). Thesis intact (Grok: no material negative news; InP/AI data center thesis unchanged). Day P&L=-3.80% (< 40% daily cap). No watchlist candidates from pre-market pass (best scores: LZB=6, INTC=6; all below threshold of 7).
...
2026-06-24 midday: 0 exits. KMX last $52.105 (ret=+7.59% vs entry $48.43) — stop at -25% ($36.32) and target at +60% ($77.49) neither triggered; thesis intact (Grok: no material negative KMX news in last 6h; Q1 EPS beat / turnaround thesis unchanged). Day P&L=+0.19% (< 40% daily cap, no halt). Alpaca reconciled — 890 shares, matches portfolio. Time-stop 2026-06-25 = TOMORROW (EOD enforces).
2026-06-25 midday: 0 exits. KMX last $53.00 (ret=+9.44% vs entry $48.43) — stop at -25% ($36.32) and target at +60% ($77.49) neither triggered; thesis intact (Grok: no material negative KMX news in last 6h; CEO insider buying noted, Q1 EPS beat thesis unchanged). Day P&L=+2.28% (< 40% daily cap, no halt). Alpaca reconciled — 890 shares, matches portfolio. Time-stop 2026-06-25 = TODAY (EOD enforces).
