...
| 2026-08-19 08:35 | KEYS | BUY | 20 | 340.8005 | equity score=8 catalyst=Q3 adj EPS $3.07 vs ~$2.48 cons (+24.8%), rev $1.846B, Q4 guide raised to $3.34-3.40 EPS vs ~$2.68 cons (+26%) and +37% YoY rev, record orders >$2B 2nd straight qtr (IR 08-18); call path ineligible (KEYS has monthly-only expiries — 08-21 = 2 DTE below option_min_days_to_expiry:3, next is 09-18 = 30 DTE; 0 contracts in the 08-22..08-26 window), fell back to shares per KMX 06-18/PENG 07-08/CCK 07-22 precedent; **novelty re-measured at the open per ALB 08-06 rule and PASSED** — +1.76% vs 08-18 close $341.00, far below the +5% kill threshold pre-market set; 98% haircut sized 20 @ $346.99 mark but filled $340.8005 = **-1.78% favorable slippage**, cash +$421.91 so `no_margin` did NOT reopen; slow drip fill 1m35s 12→15→20 (order 27f26670) | 8 | 2026-08-26 |
